    ...
    describe('#_dynamicConnectionToConnection', function () {
      ...
      describe('connection for sibling elements', function () {
        ...
        it('should have a same properties as the parameter object', function () {
          var connection = connectionMgr._dynamicConnectionToConnection(conConfig);
          connection.should.have.deep.property('connectionId', conConfig.connectionId);
          connection.should.have.deep.property('source', conConfig.source);
          connection.should.have.deep.property('destination', conConfig.destination);
          connection.should.have.deep.property('repeatedValues', conConfig.repeatedValues);
          connection.should.have.deep.property('copyValue', conConfig.copyValue);
          connection.should.have.deep.property('hookFunction', conConfig.hookFunction);
          connection.should.have.deep.property('internal', false);
        });
      });
      describe('internal connection', function () {
        ...
        it('should have a same properties as the parameter object', function () {
          ...
          connection.should.have.deep.property('copyValue', conConfig.copyValue);
          connection.should.have.deep.property('hookFunction', conConfig.hookFunction);
          connection.should.have.deep.property('internal', true);
        });
      });
    });
