...
describe('CIF', function () {
  ...
  var coreInitElement;
  var expectedValues = {
      number: { slotName: 'number', slotValueAsJSON: 10, slotValue: 10 },
      htmlCode: { slotName: 'htmlCode', slotValueAsJSON: '"<p>Text text text</p>"', slotValue: '<p>Text text text</p>' },
      string: { slotName: 'string', slotValueAsJSON: '"this is a string"', slotValue: 'this is a string' },
      object: { slotName: 'object', slotValueAsJSON: '{ "number": 5, "boolean": true }', slotValue: { "number": 5, "boolean": true } },
      list: { slotName: 'list', slotValueAsJSON: '[ 1, 2, "text", true ]', slotValue: [ 1, 2, "text", true ] },
      invalid: { slotName: 'jsCode', slotValueAsJSON: 'alert("hi");' },
  ...
  describe('cubx-core-slot-init using script for textContent', function () {
      ...
      it('should inject a script within the cubx-core-slot-init', function () {
          ...
          console.log('tagName', coreInitElement.outerHTML)
