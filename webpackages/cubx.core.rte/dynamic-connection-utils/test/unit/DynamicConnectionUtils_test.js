    ...
    describe('#_createConnectionManagerConnectionObject', function () {
      ...
      describe('called on source element', function () {
        it('should create a valid connection', function () {
          ...
          connection.should.deep.nested.property('source.component', sourceElem);
          connection.should.deep.nested.property('source.slot', dynamicConnection.source.slot);
          connection.should.have.nested.property('destination.memberId', 'member2');
          connection.should.deep.nested.property('destination.component', destElem);
          connection.should.deep.nested.property('destination.slot', dynamicConnection.destination.slot);
  ...
  describe('#importConnections', function () {
    ...
    describe('import connections between elem1 and elem2, imported on elem1', function () {
      ...
      it('should exist in compElem context', function () {
        ...
        connection.should.have.nested.property('source.memberId', 'member1');
        connection.should.deep.nested.property('source.component', elem1);
        connection.should.deep.nested.property('source.slot', dynamicConnections[ 0 ].source.slot);
        connection.should.have.nested.property('destination.memberId', 'member2');
        connection.should.deep.nested.property('destination.component', elem2);
        connection.should.deep.nested.property('destination.slot', dynamicConnections[ 0 ].destination.slot);
    ...
    describe(
      ...
      function () {
        ...
        it('should exist in compElem context', function () {
          ...
          connection.should.deep.nested.property('source.slot', dynamicConnections[ 0 ].source.slot);
          connection.should.have.nested.property('destination.memberId', 'member2');
          connection.should.deep.nested.property(
    ...
    describe('import 3 connections for 2 contexts, imported on elem1', function () {
      ...
      it('should 2 connections exist in context of compElem', function () {
        ...
        connection.should.have.deep.nested.property('source.slot', dynamicConnections[ 0 ].source.slot);
        ...
        connection.should.have.deep.nested.property('destination.slot', dynamicConnections[ 0 ].destination.slot);
        connection.should.have.property('repeatedValues', dynamicConnections[ 0 ].repeatedValues);
        connection.should.have.property('copyValue', dynamicConnections[ 0 ].copyValue);
        connection.should.have.property('hookFunction', dynamicConnections[ 0 ].hookFunction);
        ...
        connection.should.have.deep.nested.property('source.memberId', 'member2');
        connection.should.have.deep.nested.property('source.component', elem2);
        connection.should.have.deep.nested.property('source.slot', dynamicConnections[ 1 ].source.slot);
        connection.should.have.deep.nested.property('destination.memberId', 'member3');
        connection.should.have.deep.nested.property('destination.component', elem3);
        connection.should.have.deep.nested.property('destination.slot', dynamicConnections[ 1 ].destination.slot);
        connection.should.have.property('repeatedValues', false);
        connection.should.have.property('copyValue', true);
      ...
      it('should exists in context of compElem2', function () {
        ...
        connection.should.have.deep.nested.property('source.memberId', 'member1');
        connection.should.have.deep.nested.property('source.component', elem4);
        connection.should.have.deep.nested.property('source.slot', dynamicConnections[ 2 ].source.slot);
        connection.should.have.nested.property('destination.memberId', 'member2');
        connection.should.have.deep.nested.property('destination.component', elem5);
        connection.should.have.deep.nested.property('destination.slot', dynamicConnections[ 2 ].destination.slot);
    ...
    describe('import internal connections (from compound to child element)', function () {
      ...
      it('should exist in compElem context', function () {
        ...
        connection.should.have.deep.nested.property('source.component', compElem);
        connection.should.have.deep.nested.property('source.slot', dynamicConnections[ 0 ].source.slot);
        connection.should.have.nested.property('destination.memberId', 'member2');
        connection.should.have.deep.nested.property('destination.component', elem2);
        connection.should.have.deep.nested.property('destination.slot', dynamicConnections[ 0 ].destination.slot);
    ...
    describe('import internal connections (from child element to compound)', function () {
      ...
      it('should exist in compElem context', function () {
        ...
        connection.should.deep.nested.property('source.component', elem2);
        connection.should.deep.nested.property('source.slot', dynamicConnections[ 0 ].source.slot);
        connection.should.have.nested.property('destination.memberId', null);
        connection.should.deep.nested.property('destination.component', compElem);
        connection.should.deep.nested.property('destination.slot', dynamicConnections[ 0 ].destination.slot);
        connection.should.have.property('repeatedValues', dynamicConnections[ 0 ].repeatedValues);
        connection.should.have.property('copyValue', dynamicConnections[ 0 ].copyValue);
        connection.should.have.property('hookFunction', dynamicConnections[ 0 ].hookFunction);
