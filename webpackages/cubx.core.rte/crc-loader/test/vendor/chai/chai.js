...
var config = require('./chai/requirejs_config');
...
var config = require('./requirejs_config');
...
require.register("chai/lib/chai/requirejs_config.js", function(exports, require, module){
module.exports = {

  /**
   * ### requirejs_config.includeStack
   *
   * User configurable property, influences whether stack trace
   * is included in Assertion error message. Default of false
   * suppresses stack trace in the error message.
   *
   *     chai.requirejs_config.includeStack = true;  // enable stack on error
   *
   * @param {Boolean}
   * @api public
   */
  ...
  /**
   * ### requirejs_config.truncateThreshold
   *
   ...
   *
   *     chai.requirejs_config.truncateThreshold = 0;  // disable truncating
   *
   * @param {Number}
   * @api public
   */
